...
// The functions below we wont be using as these are not built for chunk by chunk compression
int Compressor::def(std::ifstream &source, std::ofstream &destination) {
